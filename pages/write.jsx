...
const Write = () => {
  ...
  const saveToServer = async (file) => {
    ...
    const uploadRes = await axios.post(
      "https://api.cloudinary.com/v1_1/dxskael19/image/upload",
      body
    );
            ...
            <div className="write__formGroup" style={{ marginBottom: "16px" }}>
              ...
              {category[0] === "economy" && (
                ...
                >
                  ...
                  <option value="innovation">Công Nghệ Web</option>
                  <option value="tourism">Chương Trình</option>
                </select>
              )}
              ...
              {category[0] === "society" && (
                ...
                >
                  <option style={{ display: "none" }}>Danh mục phụ</option>
                  <option value="civil-protection">Máy Photocopy</option>
                  <option value="education">Máy In</option>
                  <option value="housing">Dòng Mực</option>
                  <option value="urban-planning">Khác</option>
                </select>
              )}
            </div>
